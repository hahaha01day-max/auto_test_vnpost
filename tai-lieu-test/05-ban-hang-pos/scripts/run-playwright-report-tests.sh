...
# Runner chuẩn Playwright Test cho tài liệu 05, sinh HTML report và video cả case pass.
...
Cách dùng:
  ...
  ./tai-lieu-test/05-ban-hang-pos/scripts/run-playwright-report-tests.sh headed
  ./tai-lieu-test/05-ban-hang-pos/scripts/run-playwright-report-tests.sh report
HELP
    exit 1
    ;;
esac
