...
# Runner Playwright Test cho tài liệu 08, sinh HTML report và video cả case pass.
...
Cach dung:
  ./tai-lieu-test/08-khach-hang-than-thiet-loyalty/scripts/run-playwright-report-tests.sh test
  ./tai-lieu-test/08-khach-hang-than-thiet-loyalty/scripts/run-playwright-report-tests.sh headed
  ./tai-lieu-test/08-khach-hang-than-thiet-loyalty/scripts/run-playwright-report-tests.sh report
HELP
    exit 1
    ;;
esac
