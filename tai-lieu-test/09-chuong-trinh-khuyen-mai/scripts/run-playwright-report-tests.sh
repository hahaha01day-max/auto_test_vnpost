...
# Runner Playwright Test cho tài liệu 09, sinh HTML report và video cả case pass.
...
Cach dung:
  ./tai-lieu-test/09-chuong-trinh-khuyen-mai/scripts/run-playwright-report-tests.sh test
  ./tai-lieu-test/09-chuong-trinh-khuyen-mai/scripts/run-playwright-report-tests.sh headed
  ./tai-lieu-test/09-chuong-trinh-khuyen-mai/scripts/run-playwright-report-tests.sh report
HELP
    exit 1
    ;;
esac
